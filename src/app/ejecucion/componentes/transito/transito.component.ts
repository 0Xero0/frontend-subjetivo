...
export class TransitoComponent implements OnInit {
  ...
  llenarPreguntas(preguntas:any){
    ...
    this.selectG3 = this.preguntas.gruas.find((t: any) => t.preguntaId === 9)?.valor || "";
    this.textG5 = this.preguntas.gruas.find((t: any) => t.preguntaId === 10)?.valor || "";
    this.selectG4 = this.preguntas.gruas.find((t: any) => t.preguntaId === 11)?.valor || "";
    this.fechaG1 = this.preguntas.gruas.find((t: any) => t.preguntaId === 12)?.valor || "";
    this.fechaG2 = this.preguntas.gruas.find((t: any) => t.preguntaId === 13)?.valor || "";
    this.selectG5 = this.preguntas.gruas.find((t: any) => t.preguntaId === 14)?.valor || "";
    this.numeroG3 = this.preguntas.gruas.find((t: any) => t.preguntaId === 15)?.valor || "";
    this.textG6 = this.preguntas.gruas.find((t: any) => t.preguntaId === 16)?.valor || "";
    this.numeroG5 = this.preguntas.gruas.find((t: any) => t.preguntaId === 18)?.valor || "";
    /* patios */
    ...
    this.selectP3 = this.preguntas.patios.find((t: any) => t.preguntaId === 9)?.valor || "";
    this.textP5 = this.preguntas.patios.find((t: any) => t.preguntaId === 10)?.valor || "";
    this.selectP4 = this.preguntas.patios.find((t: any) => t.preguntaId === 11)?.valor || "";
    this.fechaP1 = this.preguntas.patios.find((t: any) => t.preguntaId === 12)?.valor || "";
    this.fechaP2 = this.preguntas.patios.find((t: any) => t.preguntaId === 13)?.valor || "";
    this.selectP5 = this.preguntas.patios.find((t: any) => t.preguntaId === 14)?.valor || "";
    this.numeroP3 = this.preguntas.patios.find((t: any) => t.preguntaId === 15)?.valor || "";
    this.textP6 = this.preguntas.patios.find((t: any) => t.preguntaId === 16)?.valor || "";
    this.numeroP5 = this.preguntas.patios.find((t: any) => t.preguntaId === 18)?.valor || "";
    /* tramitesTransito */
    ...
    this.selectD3 = this.preguntas.deteccionInfracciones.find((t: any) => t.preguntaId === 9)?.valor || "";
    this.textD5 = this.preguntas.deteccionInfracciones.find((t: any) => t.preguntaId === 10)?.valor || "";
    this.selectD4 = this.preguntas.deteccionInfracciones.find((t: any) => t.preguntaId === 11)?.valor || "";
    this.fechaD1 = this.preguntas.deteccionInfracciones.find((t: any) => t.preguntaId === 12)?.valor || "";
    this.fechaD2 = this.preguntas.deteccionInfracciones.find((t: any) => t.preguntaId === 13)?.valor || "";
    this.selectD5 = this.preguntas.deteccionInfracciones.find((t: any) => t.preguntaId === 14)?.valor || "";
    this.numeroD3 = this.preguntas.deteccionInfracciones.find((t: any) => t.preguntaId === 15)?.valor || "";
    this.textD6 = this.preguntas.deteccionInfracciones.find((t: any) => t.preguntaId === 16)?.valor || "";
    this.numeroD5 = this.preguntas.deteccionInfracciones.find((t: any) => t.preguntaId === 18)?.valor || "";
    ...
    this.selectPC3 = this.preguntas.procesosContravencionales.find((t: any) => t.preguntaId === 9)?.valor || "";
    this.textPC5 = this.preguntas.procesosContravencionales.find((t: any) => t.preguntaId === 10)?.valor || "";
    this.selectPC4 = this.preguntas.procesosContravencionales.find((t: any) => t.preguntaId === 11)?.valor || "";
    this.fechaPC1 = this.preguntas.procesosContravencionales.find((t: any) => t.preguntaId === 12)?.valor || "";
    this.fechaPC2 = this.preguntas.procesosContravencionales.find((t: any) => t.preguntaId === 13)?.valor || "";
    this.selectPC5 = this.preguntas.procesosContravencionales.find((t: any) => t.preguntaId === 14)?.valor || "";
    this.numeroPC3 = this.preguntas.procesosContravencionales.find((t: any) => t.preguntaId === 15)?.valor || "";
    this.textPC6 = this.preguntas.procesosContravencionales.find((t: any) => t.preguntaId === 16)?.valor || "";
    this.numeroPC5 = this.preguntas.procesosContravencionales.find((t: any) => t.preguntaId === 18)?.valor || "";
    ...
    this.selectPCC3 = this.preguntas.procesoCobroCoactivo.find((t: any) => t.preguntaId === 9)?.valor || "";
    this.textPCC5 = this.preguntas.procesoCobroCoactivo.find((t: any) => t.preguntaId === 10)?.valor || "";
    this.selectPCC4 = this.preguntas.procesoCobroCoactivo.find((t: any) => t.preguntaId === 11)?.valor || "";
    this.fechaPCC1 = this.preguntas.procesoCobroCoactivo.find((t: any) => t.preguntaId === 12)?.valor || "";
    this.fechaPCC2 = this.preguntas.procesoCobroCoactivo.find((t: any) => t.preguntaId === 13)?.valor || "";
    this.selectPCC5 = this.preguntas.procesoCobroCoactivo.find((t: any) => t.preguntaId === 14)?.valor || "";
    this.numeroPCC3 = this.preguntas.procesoCobroCoactivo.find((t: any) => t.preguntaId === 15)?.valor || "";
    this.textPCC6 = this.preguntas.procesoCobroCoactivo.find((t: any) => t.preguntaId === 16)?.valor || "";
    this.numeroPCC5 = this.preguntas.procesoCobroCoactivo.find((t: any) => t.preguntaId === 18)?.valor || "";
    ...
    this.selectPCP3 = this.preguntas.procesoCobroPersuasivo.find((t: any) => t.preguntaId === 9)?.valor || "";
    this.textPCP5 = this.preguntas.procesoCobroPersuasivo.find((t: any) => t.preguntaId === 10)?.valor || "";
    this.selectPCP4 = this.preguntas.procesoCobroPersuasivo.find((t: any) => t.preguntaId === 11)?.valor || "";
    this.fechaPCP1 = this.preguntas.procesoCobroPersuasivo.find((t: any) => t.preguntaId === 12)?.valor || "";
    this.fechaPCP2 = this.preguntas.procesoCobroPersuasivo.find((t: any) => t.preguntaId === 13)?.valor || "";
    this.selectPCP5 = this.preguntas.procesoCobroPersuasivo.find((t: any) => t.preguntaId === 14)?.valor || "";
    this.numeroPCP3 = this.preguntas.procesoCobroPersuasivo.find((t: any) => t.preguntaId === 15)?.valor || "";
    this.textPCP6 = this.preguntas.procesoCobroPersuasivo.find((t: any) => t.preguntaId === 16)?.valor || "";
    this.numeroPCP5 = this.preguntas.procesoCobroPersuasivo.find((t: any) => t.preguntaId === 18)?.valor || "";
    /* recaudoMultas */
    ...
    this.selectR3 = this.preguntas.recaudoMultas.find((t: any) => t.preguntaId === 9)?.valor || "";
    this.textR5 = this.preguntas.recaudoMultas.find((t: any) => t.preguntaId === 10)?.valor || "";
    this.selectR4 = this.preguntas.recaudoMultas.find((t: any) => t.preguntaId === 11)?.valor || "";
    this.fechaR1 = this.preguntas.recaudoMultas.find((t: any) => t.preguntaId === 12)?.valor || "";
    this.fechaR2 = this.preguntas.recaudoMultas.find((t: any) => t.preguntaId === 13)?.valor || "";
    this.selectR5 = this.preguntas.recaudoMultas.find((t: any) => t.preguntaId === 14)?.valor || "";
    this.numeroR3 = this.preguntas.recaudoMultas.find((t: any) => t.preguntaId === 15)?.valor || "";
