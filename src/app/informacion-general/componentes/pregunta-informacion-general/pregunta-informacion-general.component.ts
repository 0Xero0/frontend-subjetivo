...
import { Pregunta } from 'src/app/encuestas/modelos/Encuesta';
import { Motivo } from 'src/app/encuestas/modelos/Motivo';
...
@Component({
  selector: 'app-pregunta-informacion-general',
  templateUrl: './pregunta-informacion-general.component.html',
  styleUrls: ['./pregunta-informacion-general.component.css']
})
export class PreguntaInformacionGeneralComponent {
